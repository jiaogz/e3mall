...
public class JedisTest {
	...
	public void testJedisCluster() throws Exception {
		...
		nodes.add(new HostAndPort("192.168.246.128", 7001));
		nodes.add(new HostAndPort("192.168.246.128", 7002));
		nodes.add(new HostAndPort("192.168.246.129", 7003));
		nodes.add(new HostAndPort("192.168.246.129", 7004));
		nodes.add(new HostAndPort("192.168.246.130", 7005));
		nodes.add(new HostAndPort("192.168.246.130", 7006));
