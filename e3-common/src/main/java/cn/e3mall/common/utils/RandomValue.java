...
public class RandomValue {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getNum(0,100));
        System.out.println(getEmail(0,100));
        System.out.println(email_suffix.length);
        System.out.println((int)(Math.random()*email_suffix.length));
